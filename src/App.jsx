...
function App() {
  ...
  return (
    <div className="p-4 flex flex-col items-center w-full">
      <h1 className="text-2xl font-bold mb-1">Predicting Vehicle Registration Numbers - C964 Capstone Project</h1>
      ...
      <p className="m-3 text-lg mb-8">Have you ever needed to view past or future projections of vehicle registration numbers? What this tool does is allows users to analyze past historical registration numbers by state or utilize a machine learning algorithm to predict vehicle registration trends up to 10 years into the future. This can help with resource planning for government agencies along with businesses that coincide with vehicle registration. We provide unique data to help users get an idea on where to expect new vehicular trends.</p>
